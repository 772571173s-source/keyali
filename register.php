...
<head>
    ...
    <style>
        body { background: #020617; color: #fff; font-family: 'Segoe UI', Tahoma, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
        .auth-card { background: #0f172a; border: 2px solid #334155; padding: 40px; border-radius: 20px; width: 100%; max-width: 400px; box-shadow: 0 15px 30px rgba(0,0,0,0.5); text-align: center; }
        .auth-input { width: 100%; padding: 12px 20px; margin: 12px 0; box-sizing: border-box; background: #1e293b; border: 1px solid #475569; border-radius: 10px; color: #fff; font-size: 16px; outline: none; transition: 0.3s; text-align: center; }
        .auth-input:focus { border-color: #38bdf8; box-shadow: 0 0 15px rgba(56, 189, 248, 0.3); }
        .auth-btn { background: #38bdf8; color: #000; width: 100%; padding: 14px; border: none; border-radius: 10px; font-size: 18px; font-weight: bold; cursor: pointer; transition: 0.2s; margin-top: 15px; }
        .auth-btn:hover { background: #7dd3fc; transform: scale(1.02); }
