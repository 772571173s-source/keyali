...
<head>
    ...
    <style>
        ...
        .action-link.edit-challenge {
            background: rgba(245, 158, 11, 0.15);
            color: #f59e0b;
            border: 1px solid #f59e0b;
        }

        .action-link.edit-challenge:hover {
            background: #f59e0b;
            color: #000;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* إخفاء الهيدر الرئيسي لأنه غير مفيد عمودياً */
            ...
            #challenges-section .data-table td {
                text-align: left;
            }
            ...
            /* جعل الأزرار تأخذ نصف المساحة جنباً إلى جنب لتسهيل اللمس بجهازك */
        }
    </style>
</head>
                ...
                <table class="data-table">
                    ...
                    <tbody id="words-tbody">
                        <?php if (empty($all_words)): ?>
                            <tr>
                                <td colspan="4" style="text-align: center; color: #64748b;">لا توجد كلمات مضافة حتى الآن!</td>
                            </tr>
                        <?php endif; ?>
                ...
                <table class="data-table">
                    ...
                    <tbody id="codes-tbody">
                        <?php if (empty($all_codes)): ?>
                            <tr>
                                <td colspan="5" style="text-align: center; color: #64748b;">لا توجد أكواد برمجية مضافة حتى الآن!</td>
                            </tr>
                        <?php endif; ?>
                        <?php foreach ($all_codes as $code): ?>
                            <tr class="item-row" data-search-text="<?php echo htmlspecialchars(strtolower($code['description'] . ' ' . $code['code_text'])); ?>">
                                ...
                                <td data-label="الكود">
                                    <div class="code-render"><?php echo htmlspecialchars($code['code_text']); ?></div>
                                </td>
                ...
                <table class="data-table">
                    ...
                    <tbody id="challenges-tbody">
                        <?php if (empty($all_challenges)): ?>
                            <tr>
                                <td colspan="5" style="text-align: center; color: #64748b;">لا توجد جمل إنجليزية مضافة حتى الآن!</td>
                            </tr>
                        <?php endif; ?>
