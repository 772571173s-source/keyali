...
<head>
    ...
    <style>
        ...
        .form-container { max-width: 700px; margin: 0 auto; background: #0f172a; padding: 35px; border-radius: 20px; border: 1px solid #1e293b; box-shadow: 0 10px 30px rgba(0,0,0,0.5); box-sizing: border-box; }
        ...
        .form-control { width: 100%; padding: 14px 18px; background: #1e293b; border: 1px solid #334155; border-radius: 10px; color: #fff; font-size: 16px; box-sizing: border-box; transition: all 0.2s ease; -webkit-appearance: none; }
        ...
        .btn-submit { width: 100%; padding: 16px; background: #4ade80; color: #020617; border: none; border-radius: 10px; font-size: 16px; font-weight: bold; cursor: pointer; transition: all 0.2s ease; box-sizing: border-box; }
        ...
        .note-card { background: rgba(245, 158, 11, 0.08); border: 1px dashed #f59e0b; padding: 15px; border-radius: 10px; color: #f59e0b; font-size: 14px; margin-bottom: 25px; line-height: 1.6; text-align: right; box-sizing: border-box; }
        ...
        .badge-word { background: rgba(74, 222, 128, 0.15); color: #4ade80; padding: 4px 8px; border-radius: 6px; font-size: 13px; font-family: 'Fira Code', monospace; font-weight: bold; border: 1px solid rgba(74, 222, 128, 0.3); }
        ...
        @media (max-width: 768px) {
            ...
            .note-card { font-size: 13px; padding: 12px; }
