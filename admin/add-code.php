...
<head>
    ...
    <style>
        body { background: #020617; color: #fff; margin: 0; font-family: 'Tajawal', sans-serif; padding-bottom: 40px; }
        ...
        .form-title { color: #fff; margin-top: 0; font-size: 20px; font-weight: 700; }
        .form-desc { color: #94a3b8; margin-bottom: 20px; font-size: 13px; }
        ...
        textarea.form-control { font-family: 'Fira Code', monospace; font-size: 14px; direction: ltr; text-align: left; resize: vertical; }
        
        .alert { padding: 12px; border-radius: 10px; margin-bottom: 18px; text-align: center; font-weight: bold; font-size: 14px; }
        ...
        .submit-btn-green { background-color: #4ade80; color: #020617; }
        .submit-btn-green:hover { background-color: #22c55e; }
        .submit-btn-blue { background-color: #38bdf8; color: #020617; }
        .submit-btn-blue:hover { background-color: #0ea5e9; }
        
        /* ✨ قسم فحص الأكواد المدمج أسفل الشبكة */
        .recent-section-container { max-width: 1100px; margin: 0 auto 30px auto; padding: 0 20px; box-sizing: border-box; }
        .recent-section { background: #0f172a; border: 1px solid #1e293b; border-radius: 16px; padding: 25px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3); }
        .recent-title { font-size: 16px; font-weight: bold; color: #38bdf8; margin-bottom: 15px; }
        ...
        .table-responsive { width: 100%; overflow-x: auto; border-radius: 10px; border: 1px solid #1e293b; background: #0f172a; max-height: 350px; overflow-y: auto; }
        ...
        .back-link-container { text-align: center; margin: 20px auto 40px auto; padding: 0 20px; }
        .back-link { display: inline-block; color: #94a3b8; text-decoration: none; font-weight: bold; font-size: 15px; transition: color 0.2s; }
        .back-link:hover { color: #38bdf8; text-decoration: underline; }
        
        @media (max-width: 900px) {
            .admin-grid { grid-template-columns: 1fr; gap: 20px; margin: 15px auto; padding: 0 15px; }
            .recent-section-container { padding: 0 15px; }
            .form-container, .recent-section { padding: 20px; border-radius: 14px; }
