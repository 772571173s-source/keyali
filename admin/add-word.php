...
<head>
    ...
    <style>
        body { background: #020617; color: #fff; margin: 0; padding-bottom: 40px; font-family: 'Tajawal', sans-serif; }
        
        .navbar { background: #0f172a; border-bottom: 1px solid #1e293b; padding: 15px 20px; text-align: right; }
        .logo { font-size: 16px; font-weight: bold; color: #fff; text-decoration: none; }
        ...
        .form-title { font-size: clamp(20px, 5vw, 24px); color: #fff; margin-top: 0; font-weight: 700; }
        .form-desc { color: #94a3b8; margin-bottom: 25px; font-size: 14px; line-height: 1.5; }
        .form-group { margin-bottom: 20px; }
        .form-group label { display: block; margin-bottom: 8px; color: #38bdf8; font-weight: bold; font-size: 14px; }
        
        .input-speech-wrapper { display: flex; gap: 8px; align-items: center; width: 100%; }
        ...
        .listen-btn { background: #1e293b; border: 1px solid #334155; color: #38bdf8; padding: 12px 15px; border-radius: 10px; cursor: pointer; font-size: 16px; transition: 0.2s; display: flex; align-items: center; justify-content: center; }
        .listen-btn:hover { background: #334155; border-color: #38bdf8; }

        .alert { padding: 12px; border-radius: 10px; margin-bottom: 20px; text-align: center; font-weight: bold; font-size: 14px; }
        ...
        .submit-btn:hover { background-color: #22c55e; }
        ...
        .recent-title { font-size: 16px; font-weight: bold; color: #38bdf8; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; }
        ...
        .table-responsive { width: 100%; overflow-x: auto; border-radius: 10px; border: 1px solid #1e293b; background: #0f172a; max-height: 320px; overflow-y: auto; }
        ...
        .recent-table td { padding: 12px; border-bottom: 1px solid #1e293b; color: #e2e8f0; max-width: 180px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        ...
        .back-link { display: inline-block; color: #94a3b8; text-decoration: none; font-weight: bold; font-size: 14px; transition: color 0.2s; }
        .back-link:hover { color: #38bdf8; text-decoration: underline; }

        @media (max-width: 480px) {
            .form-container { padding: 20px 15px; margin: 15px auto; }
            .form-control { padding: 12px; font-size: 14px; }
            .listen-btn { padding: 11px 13px; font-size: 15px; }
