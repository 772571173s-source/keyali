...
<head>
    ...
    <style>
        body { font-family: 'Tajawal', sans-serif; background: #020617; color: #fff; margin: 0; padding-bottom: 20px; }
        
        /* شريط تنقل متجاوب للموبايل */
        .navbar { background: #0f172a; border-bottom: 1px solid #1e293b; padding: 15px 20px; }
        .nav-container { max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; }
        ...
        .admin-container { max-width: 1200px; margin: 40px auto; padding: 0 20px; box-sizing: border-box; }
        .header-box { display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; flex-wrap: wrap; gap: 15px; }
        .admin-title { color: #fff; font-weight: bold; margin: 0; font-size: clamp(20px, 4.5vw, 26px); }
        .your-role-badge { background: #0f172a; border: 1px solid #38bdf8; padding: 8px 16px; border-radius: 8px; color: #38bdf8; font-weight: bold; font-size: 14px; }
        
        .users-table-wrapper { background: #0f172a; border: 1px solid #334155; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.5); margin-top: 20px; padding: 10px; box-sizing: border-box; }
        .users-table { width: 100%; border-collapse: collapse; text-align: right; color: #f8fafc; }
        .users-table th { background: #1e293b; padding: 15px; color: #38bdf8; font-weight: bold; font-size: 15px; border-bottom: 2px solid #334155; }
        .users-table td { padding: 15px; border-bottom: 1px solid #1e293b; font-size: 14px; vertical-align: middle; color: #cbd5e1; }
        .users-table tr:hover { background: rgba(56, 189, 248, 0.02); }
        
        .role-badge { padding: 4px 10px; border-radius: 6px; font-size: 12px; font-weight: bold; display: inline-block; }
        .role-badge.root { background: rgba(168, 85, 247, 0.15); color: #c084fc; border: 1px solid #a855f7; }
        .role-badge.admin { background: rgba(239, 68, 68, 0.15); color: #ef4444; border: 1px solid #ef4444; }
        .role-badge.user { background: rgba(74, 222, 128, 0.15); color: #4ade80; border: 1px solid #4ade80; }
        
        /* تنسيق خط كلمة السر للروت */
        .pass-text { font-family: 'Fira Code', monospace; color: #f43f5e; font-size: 13px; background: #1e293b; padding: 4px 8px; border-radius: 6px; word-break: break-all; }
        
        .action-btn { font-family: 'Tajawal', sans-serif; padding: 8px 14px; border-radius: 8px; font-size: 13px; font-weight: bold; border: none; cursor: pointer; transition: 0.2s; display: inline-flex; align-items: center; gap: 5px; width: 100%; justify-content: center; box-sizing: border-box; }
        .action-btn.promote { background-color: #e11d48; color: #fff; }
        .action-btn.promote:hover { background-color: #be123c; }
        .action-btn.demote { background-color: #475569; color: #fff; }
        .action-btn.demote:hover { background-color: #334155; }
        .action-locked { color: #64748b; font-size: 13px; font-style: italic; display: block; }

        /* 📱 التوافق الكامل مع الموبايل */
        @media (max-width: 768px) {
            .nav-container { flex-direction: column; text-align: center; gap: 8px; }
            .admin-container { padding: 20px 10px; margin: 10px auto; }
            .header-box { flex-direction: column; align-items: flex-start; gap: 10px; }
            .your-role-badge { width: 100%; box-sizing: border-box; text-align: center; }
            .users-table-wrapper { padding: 8px; border-radius: 14px; }
            ...
            .users-table tr td.cell-id::before { content: "المعرف:"; }
            .users-table tr td.cell-username::before { content: "اسم المستخدم:"; }
            .users-table tr td.cell-email::before { content: "الإيميل:"; }
            .users-table tr td.cell-password::before { content: "كلمة السر:"; }
            .users-table tr td.cell-role::before { content: "الرتبة:"; }
            .users-table tr td.cell-actions::before { content: "التحكم:"; }
