    ...
    <style>
        ...
        @media (max-width: 992px) {
            .navbar {
                ...
                /* التأكد أنه لا يطفو فوق المحتوى */
                box-sizing: border-box;
            }

            .nav-container {
                flex-direction: column !important;
                /* اللوجو فوق والأزرار تحت */
                gap: 8px !important;
            ...
            .logo {
                ...
                /* تصغير حجم اللوجو قليلاً لتوفير مساحة */
                margin: 0 !important;
                padding-bottom: 2px;
            }
            ...
            .nav-links {
                ...
                /* 🚫 منع النزول لسطر جديد نهائياً لكي لا يرتفع الناف بار */
            ...
            .nav-item {
                ...
                /* جعل السحب يقف بشكل منسق عند كل زر */
                flex-shrink: 0 !important;
                /* منع انضغاط الأزرار أو تشوه أحجامها */
            }
            ...
            .nav-links a {
                ...
                /* تقليل البادينج العمودي ليكون الناف بار نحيفاً */
