...
<style>
    .bank-container { max-width: 900px; margin: 40px auto; font-family: 'Tajawal', sans-serif; padding: 0 15px; }
    .bank-card { background: #0f172a; border: 2px solid #1e293b; padding: 30px; border-radius: 20px; box-shadow: 0 15px 30px rgba(0,0,0,0.5); }
    .form-row { display: flex; gap: 15px; margin-bottom: 15px; flex-wrap: wrap; text-align: right; }
    .form-group { flex: 1; min-width: 200px; display: flex; flex-direction: column; }
    .form-group label { color: #94a3b8; font-weight: bold; margin-bottom: 8px; font-size: 14px; }
    .form-control { padding: 12px; background: #1e293b; border: 1px solid #475569; border-radius: 10px; color: #fff; font-size: 16px; outline: none; }
    .form-control:focus { border-color: #38bdf8; }
    
    /* أزرار اختيار النوع */
    .type-switcher { display: flex; gap: 15px; margin-bottom: 20px; }
    .type-btn { flex: 1; padding: 12px; background: #1e293b; border: 1px solid #475569; border-radius: 10px; color: #fff; font-weight: bold; cursor: pointer; text-align: center; transition: 0.2s; }
    .type-switcher input[type="radio"] { display: none; }
    .type-switcher input[type="radio"]:checked + .type-btn { background: rgba(56, 189, 248, 0.15); border-color: #38bdf8; color: #38bdf8; }

    .btn-add { background: #38bdf8; color: #000; font-weight: bold; padding: 14px; border: none; border-radius: 10px; cursor: pointer; transition: 0.2s; font-size: 16px; width: 100%; margin-top: 10px; }
    .btn-add:hover { background: #7dd3fc; }
    
    .badge { padding: 3px 8px; border-radius: 12px; font-size: 12px; font-weight: bold; }
    .badge-word { background: rgba(56, 189, 248, 0.2); color: #38bdf8; }
    .badge-code { background: rgba(245, 158, 11, 0.2); color: #f59e0b; }

    .words-table { width: 100%; border-collapse: collapse; margin-top: 20px; text-align: right; }
    .words-table th { background: #1e293b; color: #94a3b8; padding: 12px; border-bottom: 2px solid #334155; }
    .words-table td { padding: 14px 12px; border-bottom: 1px solid #1e293b; color: #fff; }
</style>
